...
Postal3DB = {
	...
	["global"] = {
		["BlackBook"] = {
			["alts"] = {
				"Argwynn|Tarren Mill|Horde|85|PALADIN", -- [1]
				"Belfrogue|Outland|Horde|1|ROGUE", -- [2]
				"Daladin|Outland|Alliance|1|PALADIN", -- [3]
				"Demlock|Tarren Mill|Horde|32|WARLOCK", -- [4]
				"Eiratos|Tarren Mill|Horde|1|WARRIOR", -- [5]
				"Fallens|Tarren Mill|Horde|60|DEATHKNIGHT", -- [6]
				"Glasin|Tarren Mill|Horde|85|MAGE", -- [7]
				"Gobifrost|Tarren Mill|Horde|1|MAGE", -- [8]
				"Kraisus|Tarren Mill|Horde|85|ROGUE", -- [9]
				"Mylen|Tarren Mill|Alliance|42|SHAMAN", -- [10]
