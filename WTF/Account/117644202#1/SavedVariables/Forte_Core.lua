...
FC_Saved = {
	...
	["Profiles"] = {
		...
		["Tikytaka"] = {
			...
			["HealthstoneExpand"] = false,
			["FearFadeMsg"] = ">> Fear on %s Fading in 3 seconds! <<",
			["GlobalSparkEnable"] = true,
			["SoulstoneBgColor"] = {
				0.31, -- [1]
				0, -- [2]
			...
			["SoulstoneFont"] = "Interface\\AddOns\\Forte_Core\\Fonts\\GOTHIC.TTF",
			["DevourMagicSuccessMsg"] = ">> Devour Magic Used <<",
			["FearBreakMsg"] = ">> Fear on %s Broke Early! <<",
			["MeetingStoneSummon"] = 0,
			["SoulstoneMsgEnable"] = true,
			["SummonKeyword"] = true,
			["SoulstoneTextColor"] = {
			...
			["OutputMsg"] = "MyProChannel",
			["CooldownStrata"] = "MEDIUM",
			["SoulstoneSuccessMsg"] = "Soulstoned >> %s << Use it well!",
			["HealthstoneBgColor"] = {
				0.31, -- [1]
				0, -- [2]
				0.62, -- [3]
			...
			["FrameSnapDistance"] = 5,
			["SoulstoneSpace"] = 1,
			["SeduceFadeMsg"] = ">> Seduction on %s Fading in 3 seconds! <<",
			["OptionHeaderColor"] = {
				0.2, -- [1]
				0.2, -- [2]
				0.2, -- [3]
			...
			["SummonTexture"] = "Interface\\AddOns\\Forte_Core\\Textures\\Aluminium",
			["HealthstoneSpace"] = 1,
			["DevourMagicSuccess"] = 0,
			["TimeFormat"] = true,
			["SoulstoneSuccessWhisper"] = true,
			["BanishBreakMsg"] = ">> Banish on %s Broke Early! <<",
			["FrameDistance"] = 0,
			["TimerInstantSoundVolume"] = 4,
			["AnimationInterval"] = 0.04,
			["Cooldown"] = {
			...
			["TimerStrata"] = "MEDIUM",
			["SoulstoneSuccessWhisperMsg"] = ">> You are now soulstoned! <<",
			["DevourMagicReadyMsg"] = ">> Devour Magic ready <<",
			["GlobalAlpha"] = 1,
			["OptionsColums"] = 2,
			["FearFade"] = 0,
			["SummonEnable"] = false,
			["SeduceSuccessMsg"] = "Seduced >> %s << Don't hit it!",
			["SummonMax"] = 5,
			["OptionsHeaderFontSize"] = 11,
			["SpellLockReady"] = 0,
			["OutputRaid"] = true,
			...
			["SummonExpand"] = false,
			["SummonFinish"] = 1,
			["RitualOfDoomStartMsg"] = "Want to end it all? Clicky clicky!",
			["HealthstoneHeight"] = 12,
			["AnimateScroll"] = false,
			["OptionsFont"] = "Interface\\AddOns\\Forte_Core\\Fonts\\GOTHIC.TTF",
			["OptionsHeight"] = 440,
			...
			["RAID"] = false,
			["TalentOffsetY"] = 0,
			["BanishFadeMsg"] = ">> Banish on %s Fading in 3 seconds! <<",
			["CooldownLeft"] = 1,
			["SoulstoneCancelWhisper"] = false,
			["OptionsFontLabelColor"] = {
				1, -- [1]
				1, -- [2]
				1, -- [3]
			...
			["SummonOldMode"] = false,
			["TimerClearcastingSoundVolume"] = 4,
			["SeduceBreakMsg"] = ">> Seduction on %s Broke Early! <<",
			["SeduceFade"] = 1,
			["TimerImproveRaidTarget"] = false,
			["SeduceBreak"] = 1,
			["EnslaveFadeMsg"] = ">> Enslave on %s Fading in 3 seconds! <<",
			["PARTY"] = false,
			["BloodpactLossColor"] = {
				1, -- [1]
				0, -- [2]
			...
			["GlobalScale"] = 1,
			["PetTargetDelay"] = 0.5,
			["SpellLockFailedMsg"] = ">> Spell Lock Failed! <<",
			["HealthstoneAuto"] = false,
			["GlobalLock"] = false,
			["Tips"] = true,
			["SoulstoneHeight"] = 12,
			...
			["HealthstoneDetailsAuto"] = false,
			["Delay"] = 0.05,
			["EnslaveBreakMsg"] = ">> Enslave on %s Broke Early! <<",
			["SparkOverrideEnable"] = false,
			["SoulstoneStartMsg"] = "Soulstoning >> %s << Now",
			["SoulstoneCancelMsg"] = "Soulstoning >> %s << Cancelled",
			["TimerBreakSoundVolume"] = 4,
			["BloodPact"] = false,
			["SummonInterval"] = 1,
			["SummonFontSize"] = 11,
			["SummonHeight"] = 12,
			["SpellLockSuccessMsg"] = ">> Spell Lock Used <<",
			["TimerResistSoundEnable"] = true,
			["TimerInstantSound"] = "Sound\\Spells\\ShadowWard.wav",
			["CancelDelay"] = 0.5,
			["SummonBgColor"] = {
			...
			["SoulstoneStartWhisperMsg"] = ">> Soulstoning you now <<",
			["HealthstoneWidth"] = 100,
			["SeduceFailedMsg"] = ">> Seduction Failed! <<",
			["DevourMagicFailed"] = 0,
			["SummonFinishMsg"] = ">> Opening Summoning Portal << Clicky clicky!",
			["Mix"] = 0.5,
			["SoulstoneFadeSoundEnable"] = true,
			["RightClickOptions"] = true,
			["TimeLeftMsg"] = ">> %s on %s is fading in %s <<",
			...
			["DevourMagicFailedMsg"] = ">> Devour Magic Failed! <<",
			["HealthstoneStrata"] = "MEDIUM",
			["SummonFarColor"] = {
				1, -- [1]
				1, -- [2]
			...
			["Strata"] = "MEDIUM",
			["SoulwellStartMsg"] = "Summoning >> Soulwell << Yummie!",
			["SpellLockFailed"] = 0,
			["HealthstoneTotal"] = false,
			["TimerBreakSound"] = "Sound\\Spells\\SimonGame_Visual_LevelStart.wav",
			["TimerClearcastingSound"] = "Sound\\Spells\\SimonGame_Visual_GameStart.wav",
			["MeetingStoneSummonMsg"] = "Summoning >> %s << Clicky clicky!",
			["SpellLockReadyMsg"] = ">> Spell Lock ready <<",
			["TimeLeftNoTargMsg"] = ">> %s is fading in %s <<",
			["SeduceStart"] = 0,
			["SoulstoneAuto"] = false,
			["SoulstoneExpand"] = false,
			...
			["SoulstoneCancelWhisperMsg"] = "<< Soulstoning cancelled >>",
			["SafeBlockShardReagent"] = false,
			["SoulstoneFadeSound"] = "Interface\\AddOns\\Forte_Core\\Sounds\\SoulstoneExpire.mp3",
			["GlobalSpark"] = 0.7,
			["SpellLockSuccess"] = 0,
	...
	["Speccs"] = {
		["DEATHKNIGHT"] = {
			...
			["Arthãs"] = "023032053062083091103112122132142153161171183192201   00",
		},
		["WARRIOR"] = {
			["Succénd"] = "032 013 013032043053062072081091102111122131142172193201 00",
			["Nimloth"] = "013032042063092103113 013035053095105112133141175183191202225241253265271  00",
			["Devastathor"] = "022 013 012023032053062072081091102111122131152161172193201 00",
			["Soaker-Kazzak"] = "   00",
			["Eiratos"] = "   00",
		},
		["ROGUE"] = {
			["Grámps"] = "022033042 023033042052063083091123132151162173182191 033 00",
			["Propew"] = "035043063095103115122131165172191213223233241265271 035065095123 012 00",
			["Belfrogue"] = "   00",
			["Viiru"] = "023033043052063081091103122132141151173182191 033 012033062 00",
			["Kraisus"] = "022033052061 012 012023033042063083092101111121143151162173191 00",
		},
		["MAGE"] = {
		...
		["PRIEST"] = {
			["Surilliar"] = "023031 012023033041052062072082091102111122141151173182191201  00",
			["Bammbi"] = "015032043073081093113122132145151162173183191212223232243251261275281 012023035061083  00",
			["Vital-Kazzak"] = "023032  013022032053062072081102121132142152161192203211 00",
			...
