...
L["Shopping - Milling / Disenchanting / Prospecting Options"] = true
L["The options below apply to \"Shopping - Milling / Disenchanting / Prospecting\" searches (including those done while shopping for crafting mats)."] = true
