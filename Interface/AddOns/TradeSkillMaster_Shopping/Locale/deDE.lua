...
L["Add Item to Dealfinder List:"] = "Item zur Dealfinder-Liste hinzufügen" -- Needs review
...
L["Configure Dealfinder List"] = "Dealfinder Liste Konfigurieren" -- Needs review
L["Configures your Dealfinder list."] = "Konfiguriert Ihre Dealfinder Liste." -- Needs review
...
L["Invalid monney format entered, should be \"#g#s#c\", \"25g4s50c\" is 25 gold, 4 silver, 50 copper."] = "Ungültiger Geldbetrag eingegeben. So sollte es aussehen: \"#g#s#c\". zB:\"25g4s50c\" ist 25 Gold, 4 Silber und 50 Kupfer." -- Needs review
...
L["Item was already in the Dealfinder list. Price has been overriden (old price was %s)."] = "Das Item befand sich bereits in der Dealfinder Liste. Der Preis wurde überschrieben (der alte Preis war %s)." -- Needs review
...
L["No auctions are under your Dealfinder prices."] = "Es gibt keine Auktionen innerhalb ihrer gesetzten Schnäppchenjäger Preise." -- Needs review
...
L["Run Dealfinder Scan"] = "Starte Schnäppchenjäger Suche" -- Needs review
L["SKIP"] = "Überspringen" -- Needs review
L["Scan Canceled"] = "Scan abgebrochen" -- Needs review
L["Scan interupted due to auction house being closed."] = "Der AH-Scan wurde abgebrochen weil das Auktionshausfenster geschlossen wurde." -- Needs review
L["Scan interupted due to automatic mode being canceled."] = "Der AH-Scan wurde abgebrochen weil der automatische Modus abgebrochen wurde." -- Needs review
L["Scans for all items in your Dealfinder list."] = "Beginne die Suche nach allen Items meiner Schnäppchenjäger Liste" -- Needs review
...
Must be entered in the form of "#g#s#c". For example "5g24s98c" would be 5 gold 24 silver 98 copper.]=] ] = "Der maximale Preis (pro 1 Item) welches Sie durch den Dealfinder scan erwerben wollen." -- Needs review
