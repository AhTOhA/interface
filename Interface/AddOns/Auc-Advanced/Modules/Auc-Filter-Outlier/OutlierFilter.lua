--[[
	...
	Revision: $Id: OutlierFilter.lua 4840 2010-08-04 21:44:00Z Nechckn $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.9/Auc-Filter-Outlier/OutlierFilter.lua $", "$Rev: 4840 $")
