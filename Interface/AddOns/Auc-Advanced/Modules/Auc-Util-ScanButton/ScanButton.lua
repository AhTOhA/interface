--[[
	...
	Revision: $Id: ScanButton.lua 4880 2010-09-15 20:02:11Z Nechckn $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/branches/5.9/Auc-Util-ScanButton/ScanButton.lua $", "$Rev: 4880 $")
