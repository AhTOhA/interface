...
elseif GetLocale() == "deDE" then	
	...
	FWL.CD_SPECIFIC8 = "Tausche Leistenrichtung";
	FWL.CD_SPECIFIC8_TT = "Tauscht die Richtung der Leiste.";
	...
	FWL.CD_WEAPON_ENCHANT_MAIN = "Waffenverzauberung (Haupthand)";
	FWL.CD_WEAPON_ENCHANT_OFFHAND = "Waffenverzauberung (Nebenhand)";
