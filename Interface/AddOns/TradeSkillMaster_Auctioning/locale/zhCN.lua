...
L["% of AuctionDB Market Value"] = "% 拍卖行数据库中的市场价" -- Needs review
L["% of AuctionDB Minimum Buyout"] = "% 拍卖行数据库中的最低一口价" -- Needs review
-- L["% of Auctioneer Appraiser"] = ""
L["% of Auctioneer Market Value"] = "% 拍卖行的市场价" -- Needs review
L["% of Auctioneer Minimum Buyout"] = "% 拍卖行的最低一口价" -- Needs review
L["% of Crafting cost"] = "% 制造成本价" -- Needs review
-- L["% of ItemAuditor cost"] = ""
L["12 hours"] = "12小时" -- Needs review
L["24 hours"] = "24小时" -- Needs review
L["48 hours"] = "48小时" -- Needs review
L["<Uncategorized Groups>"] = "<未归类的组>" -- Needs review
-- L["<none>"] = ""
...
-- L["Add/Remove"] = ""
L["Add/Remove Groups"] = "新建/移除 分组" -- Needs review
L["Add/Remove Items"] = "新建/移除 物品" -- Needs review
L["Advanced"] = "高级" -- Needs review
L["Advanced Price Settings (Market Reset)"] = "高级价格设置(重置市场)" -- Needs review
...
L["Auctioning - Cancel"] = "拍卖 - 取消货物" -- Needs review
L["Auctioning - Cancel All"] = "拍卖 - 取消所有货物" -- Needs review
L["Auctioning - Cancel All Scan"] = "拍卖 - 取消所有货物扫描" -- Needs review
L["Auctioning - Cancel Scan"] = "拍卖 - 取消货物扫描" -- Needs review
...
L["Auctioning will follow the 'Advanced Price Settings' when the market goes below %s."] = "当市场价格低于%s时拍卖将会遵照 '高级价格设置'" -- Needs review
L["Auctioning will never post your auctions for below %s."] = "低于%s则拍卖不会发布你的货物" -- Needs review
L["Auctioning will post at %s when there are no other auctions up."] = "没有其他竞争者时拍卖将会以%s发布" -- Needs review
-- L["Auctioning will post at %s when you are the only one posting below %s."] = ""
L["Auctioning will undercut your competition by %s. When posting, the bid of your auctions will be set to %s percent of the buyout."] = "拍卖将削价%s发布.当发布时,竞标价将设为一口价的百分之%s." -- Needs review
L["Auctions will be posted at %s when the market goes below your threshold."] = "当市场底价低于你的最低门槛价时,拍卖将以%s发布." -- Needs review
...
L["Auctions will be posted at your fallback price of %s when the market goes below your threshold."] = "当市场底价低于你的最低门槛价时,拍卖将会以你的回跌价%s发布." -- Needs review
L["Auctions will be posted at your threshold price of %s when the market goes below your threshold."] = "当市场底价低于你的最低门槛价时,拍卖将会以你的最低门槛价%s发布." -- Needs review
