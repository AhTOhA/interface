...
function Manage:CreatePostPriceWindow(parent)
	...
	local btn = CreateButton(L["Cancel"], container, nil, "UIPanelButtonTemplate", nil, 25, {"BOTTOMLEFT", 128, 5}, {"BOTTOMRIGHT", -4, 5}, L["Close this window and discard the price entered above."])
