...
L["Adds a bar inside the health bar indicating how much healing someone is estimated to be receiving."] = "Fügt innerhalb der Gesundheitsleiste eine weitere Leiste hinzu, die anzeigt, wieviel Heilung jemand voraussichtlich erhält."
...
L["Adds eclipse bars and how far into sun or moon eclipse is.."] = "Fügt Finsternis-Leisten hinzu und wie weit Fortgeschritten die Sonnen-, bzw. Mondfinsternis ist."
L["Adds rune bars and timers before runes refresh to the player frame."] = "Fügt dem Spielerfenster eine Runenleiste sowie einen Timer bevor diese aktualisiert werden, hinzu."
...
L["Health bar color used as the transitional color for 50% -> 0% on players, as well as when your pet is very unhappy."] = "Übergangsfarbe, die benutzt wird für die Lebensanzeige von 50% auf 0% beim Spieler und wenn der Begleiter sehr glücklich ist"
...
L["Primary means of coloring the health bar, color on aggro and color by reaction will override this if necessary."] = "Wichtigere Vorgänge, die die Farbe des Lebensbalkens bei Bedrohung und Reaktion verändern überschreiben dies, falls notwendig." -- Needs review
...
L["Reaction color code, use [reactcolor][name][close] to color the units name by their reaction."] = "Reaktions Farbcode, nutze [reactcolor][name][close] um den Einheitenname durch seine Reaktion zu färben."
...
L["Text parent"] = "Text-Eltern" -- Needs review
...
L["Unlink frames"] = "Fenster entsperren"
L["Up"] = "Hoch"
...
L["When to color the empty bar by reaction, overriding the default color by option."] = "Falls die leere Leiste durch eine Reaktion die Farbe ändert, so wird die Standardfarbe durch die Option überschrieben." -- Needs review
L["When to color the health bar by the units reaction, overriding the color health by option."] = "Falls die Lebensbalkenanzeige durch die Einheitenreaktion gefärbt wird, so wird die Farbe von Lebenspunkten überschrieben"
