...
L["Adds eclipse bars and how far into sun or moon eclipse is.."] = "Добавляет полосу отслеживания статуса затмения."
...
L["Health bar color to use to show how much healing someone is about to receive."] = "Дополнительный цвет(полоса) на полосе здоровья покажет входящее исцеление, т.е. на сколько будет исцелен объект."
...
L["Turns on fast updating of health bars giving you more up to date health info."] = "Выключает быстрое обновление здоровья, позволяя получить вам информацию о здоровье быстрее, чем обычно."
