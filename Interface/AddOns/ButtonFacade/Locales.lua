...
ns.L["Reset all colors to their defaults."] = "Alle Farben auf Standard zurücksetzen."
ns.L["Set the backdrop color."] = "Tooltip-Farbe - Hintergrund"
ns.L["Set the color of the checked texture."] = "Tooltip-Farbe - Markiert"
ns.L["Set the color of the disabled texture."] = "Tooltip-Farbe - Ausgeschaltet"
ns.L["Set the color of the flash texture."] = "Tooltip-Farbe - Leuchten"
ns.L["Set the color of the gloss texture."] = "Farbe der glänzenden Textur einstellen"
ns.L["Set the color of the highlight texture."] = "Farbe der Textur zum Hervorheben einstellen"
ns.L["Set the color of the normal texture."] = "Farbe der normalen Textur einstellen"
ns.L["Set the color of the pushed texture."] = "Tooltip-Farbe - Gedrückt"
...
ns.L["Backdrop Settings"] = "Opciones de Fondo"
ns.L["Checked"] = "Activado"
ns.L["Color"] = "Color"
ns.L["Disabled"] = "Desactivado"
ns.L["Enable"] = "Activado"
ns.L["Enable the backdrop."] = "Activa el fondo"
ns.L["Flash"] = "Destello"
...
ns.L["Gloss Settings"] = "Opciones de Brillo"
ns.L["Highlight"] = "Resaltado"
ns.L["Normal"] = "Normal"
ns.L["Opacity"] = "Opacidad"
ns.L["Profiles"] = "Perfiles"
ns.L["Pushed"] = "Pulsado"
ns.L["Reset All Colors"] = "Restablecer Colores"
ns.L["Reset all colors to their defaults."] = "Reestablece todos los colores a los predefinidos"
ns.L["Set the backdrop color."] = "Establece el color de fondo de la ventana de informacion"
ns.L["Set the color of the checked texture."] = "Establece el color de la textura activada"
ns.L["Set the color of the disabled texture."] = "Establece el color de la textura desactivada"
ns.L["Set the color of the flash texture."] = "Establece el color del textura destelleando"
ns.L["Set the color of the gloss texture."] = "Establece el color de la textura brillando"
ns.L["Set the color of the highlight texture."] = "Establece el color de la textura resaltada"
ns.L["Set the color of the normal texture."] = "Establece el color de la textura normal"
ns.L["Set the color of the pushed texture."] = "establece el color de la textura pulsada"
ns.L["Set the intensity of the gloss."] = "Establece la intensidad del brillo."
ns.L["Set the skin."] = "Establece la textura de la ventana de informacion"
ns.L["Skin"] = "Textura"
ns.L["State Colors"] = "Colores Asignados"
...
ns.L["Reset all colors to their defaults."] = "Restaure les couleurs par défauts."
ns.L["Set the backdrop color."] = "Applique la couleur de fond."
ns.L["Set the color of the checked texture."] = "Applique la couleur à la texture 'cochée' (checked)."
ns.L["Set the color of the disabled texture."] = "Applique la couleur à la texture désactivée."
ns.L["Set the color of the flash texture."] = "Applique la couleur à la texture flash."
ns.L["Set the color of the gloss texture."] = "Applique la couleur brillante."
ns.L["Set the color of the highlight texture."] = "Applique la couleur à la texture de surbrillance."
ns.L["Set the color of the normal texture."] = "Applique la couleur de la texture normal."
ns.L["Set the color of the pushed texture."] = "Applique la couleur à la texture appuyée."
...
ns.L["Backdrop Settings"] = "Настройки фона"
ns.L["Checked"] = "Проверенный"
ns.L["Color"] = "Цвет"
ns.L["Disabled"] = "Отключить края"
ns.L["Enable"] = "Включить"
...
ns.L["Gloss Settings"] = "Настройки глянеца"
ns.L["Highlight"] = "Выделение"
ns.L["Normal"] = "Нормальные края"
ns.L["Opacity"] = "Прозрачность"
ns.L["Profiles"] = "Профили"
ns.L["Pushed"] = "Вдавленные края"
ns.L["Reset All Colors"] = "Сбросить цвета"
ns.L["Reset all colors to their defaults."] = "Сбросить все цвета на значения по умолчанию."
ns.L["Set the backdrop color."] = "Задать цвет фона."
ns.L["Set the color of the checked texture."] = "Установить цвет отмеченной текстуры."
ns.L["Set the color of the disabled texture."] = "Установить цвет отключенной текстуры."
ns.L["Set the color of the flash texture."] = "Установить цвет подсвеченной текстуры."
ns.L["Set the color of the gloss texture."] = "Задать цвет для глянецых текстур."
ns.L["Set the color of the highlight texture."] = "Установить цвет выделенной текстуры."
ns.L["Set the color of the normal texture."] = "Установить цвет нормальной текстуры."
ns.L["Set the color of the pushed texture."] = "Установить цвет нажатой текстуры."
ns.L["Set the intensity of the gloss."] = "Установите силу блеска."
ns.L["Set the skin."] = "Укажите скин."
ns.L["Skin"] = "Шкурки"
ns.L["State Colors"] = "Цвет состояние"
...
ns.L["Reset all colors to their defaults."] = "重置所有颜色为默认。"
ns.L["Set the backdrop color."] = "设置背景颜色。"
ns.L["Set the color of the checked texture."] = "设置已点击材质颜色。"
ns.L["Set the color of the disabled texture."] = "设置禁用材质颜色。"
ns.L["Set the color of the flash texture."] = "设置闪光材质颜色。"
ns.L["Set the color of the gloss texture."] = "设置光晕材质颜色。"
ns.L["Set the color of the highlight texture."] = "设置高亮材质颜色。"
ns.L["Set the color of the normal texture."] = "设置一般材质颜色。"
ns.L["Set the color of the pushed texture."] = "设置突出材质颜色。"
