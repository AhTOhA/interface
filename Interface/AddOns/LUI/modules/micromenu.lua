...
function module:SetMicroMenu()
	...
	TalentMicroButtonAlertBg:SetGradientAlpha("VERTICAL", micro_r/3, micro_g/3, micro_b/3, 1, 0, 0, 0, 1)
	...
	TalentMicroButtonAlertArrowGlow:SetVertexColor(0, 0, 0, 0.5)
	...
	TalentMicroButtonAlertArrowArrow:SetVertexColor(0, 0, 0)
	
	-- temp black
	TalentMicroButtonAlertGlowTopLeft:SetVertexColor(0, 0, 0)
	TalentMicroButtonAlertGlowTopRight:SetVertexColor(0, 0, 0)
	TalentMicroButtonAlertGlowBottomLeft:SetVertexColor(0, 0, 0)
	TalentMicroButtonAlertGlowBottomRight:SetVertexColor(0, 0, 0)
	
	TalentMicroButtonAlertGlowTop:SetVertexColor(0, 0, 0)
	TalentMicroButtonAlertGlowBottom:SetVertexColor(0, 0, 0)
	TalentMicroButtonAlertGlowLeft:SetVertexColor(0, 0, 0)
	TalentMicroButtonAlertGlowRight:SetVertexColor(0, 0, 0)
	
	--[[
	TalentMicroButtonAlertArrowGlow:SetTexCoord(0.40625000, 0.66015625, 0.82812500, 0.77343750)
	TalentMicroButtonAlertArrowGlow:SetVertexColor(micro_r, micro_g, micro_b, 0.5)
	TalentMicroButtonAlertArrowGlow:ClearAllPoints()
	TalentMicroButtonAlertArrowGlow:SetPoint("BOTTOM", TalentMicroButtonAlertArrow, "BOTTOM", 0, 0)
