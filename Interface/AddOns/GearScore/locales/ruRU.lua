...
L["Generate a link to this player's Online Profile at TenTonHammer.com. View World-wide rankings, comments, and more."] = "Создать ссылку на онлайн профиль этого игрока в TenTonHammer.com. Просмотр всемирного рейтинга, комментарии и многое другое.";
