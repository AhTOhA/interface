--[[
	...
	Revision: $Id: BarkerStrings.lua 4938 2010-10-14 17:41:42Z Nechckn $
...
EnchantrixBarkerLocalizations = {
	...
	koKR = {
		...
		["BarkerOptionsStaminaPriority"]	= "스태미너";
		["BarkerOptionsStaminaPriorityTooltip"]	= "스태미너 마부에 우선순위를 둡니다.";
		["BarkerOptionsStatsPriority"]	= "전체 가격 정책";
		["BarkerOptionsStatsPriorityTooltip"]	= "This sets how important the stat is to the overall priority for advertising. ";
		["BarkerOptionsStrengthPriority"]	= "힘";
		["BarkerOptionsStrengthPriorityTooltip"]	= "스태미너 마부에 우선순위를 둡니다.";
