...
local function bprint(...)
	...
	DEFAULT_CHAT_FRAME:AddMessage("CLCProt.options: " .. table.concat(t, " "))
end
...
local function GetSpellChoice()
	...
	for alias, data in pairs(clcprot.fillers) do
		...
		presets = {
			...
			args = {
				____info = {
					order = 1,
					type = "description",
					name = "This is a rudimentary presets module. Works only for Protection. It allows you to save current FCFS to a preset and to load it from there. You can also load the preset with |cffffff00/clcprotlp preset name|cffffffff.\n"					
				},
				...
				toggle = {
					...
					func = function() clcprot:PresetFrame_Toggle() end,
				},
				enableMouse = {
					order = 12,
					type = "toggle",
					...
					set = function(info, val)
						...
						clcprot:PresetFrame_UpdateMouse()
					end,
				},
					...
					args = {
						expandDown = {
							...
							set = function(info, val)
								...
								clcprot:PresetFrame_UpdateLayout()
							end,
						},
						backdropColor = {
							order = 30,
		...
		swing = {
			...
			args = {
				...
				enabled = {
					...
					set = function(info, val) clcprot:ToggleSwingTimer() end,
				},
				color = {
					order = 22,
					type = "color",
	...
	root["p" .. i] = {
		...
		args = {
			...
			load = {
				...
				type = "execute",
				name = "Load",
				func = function() clcprot:Preset_Load(i) end,
			},
			save = {
				order = 40,
				width = "half",
				type = "execute",
				name = "Save",
				func = function() clcprot:Preset_SaveCurrent(i) end,
			},
		},
	}
end
...
AceConfigDialog:AddToBlizOptions("clcprot", "clcprot", nil, "info")
AceConfigDialog:AddToBlizOptions("clcprot", "Global", "clcprot", "global")
...
AceConfigDialog:AddToBlizOptions("clcprot", "FCFS", "clcprot", "fcfs")
AceConfigDialog:AddToBlizOptions("clcprot", "Presets", "clcprot", "presets")
...
AceConfigDialog:AddToBlizOptions("clcprot", "Swing Timer", "clcprot", "swing")
