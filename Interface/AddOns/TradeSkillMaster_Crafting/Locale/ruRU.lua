...
L["Auctionator - Auction Value"] = "Auctionator - Рыночная цена"
...
L["Cloak"] = "Спина"
L["Close TSM Frame When Opening Craft Management Window"] = "Закрывать окно TSM при открытии окна управления крафтом."
...
L["Open Smelting"] = "Открыть Выплавку металлов"
...
L["Set Market Value to Auctioning Fallback"] = "Приравнять рыночную цену к верхней граничной цене."
L["Shaman"] = "Шаман"
L["Shield"] = "Щит"
L["Shimmering Ink"] = "Мерцающие чернила"
L["Show Craft Management Window"] = "Показать окно управления крафтом"
L["Smelting was not found so the craft queue has been disabled."] = "Выплавка металлов не найдена. Очередь создания отключена."
...
L["This will determine how items with unknown profit are dealth with in the Craft Management Window. If you have the Auctioning module installed and an item is in an Auctioning group, the fallback for the item can be used as the market value of the crafted item (will show in light blue in the Craft Management Window)."] = "Способ отображения крафтов с неизвестной выгодой в окне управления крафтом. Если у вас установлен модуль Auctioning и предмет находится в Аукционной группе, верхняя граничная цена этого предмета может быть использована как его рыночная цена (она будет показана светло-голубым цветом)."
