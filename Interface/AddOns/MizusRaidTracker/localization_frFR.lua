...
MRT_L.Options["AP_GuildAttendanceUseCustomText"] = "Utiliser un texte personnalisé pour la présence de guilde"
MRT_L.Options["AP_GuildAttendanceUseTrigger"] = "Utiliser le déclencheur (Trigger) à la place du nom du personnage"
...
le Raid-Log-Import 0.5.6.3 d'EQdkp-PLUS]=]
...
MRT_L.Options["TP_OnlyTrackItemsAbove"] = "Sauvegarder seulement des objets de niveau égal ou supérieur à "
