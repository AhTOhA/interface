...
MRT_L.Options["AP_GuildAttendanceDuration"] = "紀錄團隊成員的持續時間" -- Needs review
...
MRT_L.Options["EP_CTRT_RLIAttendanceFix"] = "啟用對EQdkp-Plus Raid-Log-Import 0.5.6.3的團隊成員修正"
MRT_L.Options["EP_CTRT_compatible"] = "CT RaidTracker相容" -- Needs review
...
MRT_L.Options["MP_Enabled"] = "啟用 MRT" -- Needs review
...
MRT_L.Options["TP_LogAVRaids"] = "追蹤亞夏梵穹殿" -- Needs review
...
MRT_L.Options["TP_Title"] = "追蹤中" -- Needs review
MRT_L.Options["TP_TitleText"] = "MRT - 追蹤選項" -- Needs review
...
MRT_L.GUI["Add boss attendee"] = "增加首領戰鬥參與者" -- Needs review
...
MRT_L.GUI["Difficulty N or H"] = "難度('普通' 或 '英雄')"
...
MRT_L.GUI["Itemlink"] = "物品鏈結" -- Needs review
