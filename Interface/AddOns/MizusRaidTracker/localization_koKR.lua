...
MRT_L.Options["AP_GuildAttendanceNoAuto"] = "확인 요청" -- Needs review
...
MRT_L.Options["EP_CTRT_compatible"] = "CT RaidTracker 호환" -- Needs review
...
MRT_L.Options["EP_EnglishExport"] = "보스 이름과 지역 이름을 영어로 내보내기" -- Needs review
-- MRT_L.Options["EP_HTML"] = "CSS based HTML with wowhead links"
MRT_L.Options["EP_MLDKP_15"] = "MLdkp 1.5" -- Needs review
...
MRT_L.Options["ITP_AutoFocus_Never"] = "하지 않음" -- Needs review
MRT_L.Options["ITP_AutoFocus_NoCombat"] = "전투중이 아닐때"
MRT_L.Options["ITP_AutoFocus_Title"] = "전리품 비용 다이얼로그를 자동주시" -- Needs review
...
MRT_L.Options["TP_OnlyTrackItemsBelow"] = " 동급 또는 이하의 아이템레벨" -- Needs review
MRT_L.Options["TP_Title"] = "추적" -- Needs review
MRT_L.Options["TP_TitleText"] = "MRT - 추적 설정" -- Needs review
...
MRT_L.GUI["Button_MakeGuildAttendanceCheck"] = "길드 출석체크 만듬" -- Needs review
...
MRT_L.GUI["Itemlink"] = "아이템링크" -- Needs review
