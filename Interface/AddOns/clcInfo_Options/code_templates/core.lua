...
mod.defs = {
	...
	CLASS = class,
	CLASS_1 = format("%s | %s", class, select(2, GetTalentTabInfo(1))),
	CLASS_2 = format("%s | %s", class, select(2, GetTalentTabInfo(2))),
	CLASS_3 = format("%s | %s", class, select(2, GetTalentTabInfo(3))),
}